...
--
-- Table structure for table `automobilio_grazinimo_vieta`
--

DROP TABLE IF EXISTS `automobilio_grazinimo_vieta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `automobilio_grazinimo_vieta` (
  ...
  CONSTRAINT `automobilio_grazinimo_vieta_ibfk_1` FOREIGN KEY (`automobilio_id`) REFERENCES `automobiliai` (`automobilio_id`),
  CONSTRAINT `automobilio_grazinimo_vieta_ibfk_2` FOREIGN KEY (`vietos_id`) REFERENCES `pristatymo_vietos` (`vietos_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `automobilio_grazinimo_vieta`
--

LOCK TABLES `automobilio_grazinimo_vieta` WRITE;
/*!40000 ALTER TABLE `automobilio_grazinimo_vieta` DISABLE KEYS */;
INSERT INTO `automobilio_grazinimo_vieta` VALUES (1,21,1),(2,22,2),(3,23,3),(4,24,4),(5,25,5),(6,26,1),(7,27,2),(8,28,3),(9,29,4),(10,30,5);
/*!40000 ALTER TABLE `automobilio_grazinimo_vieta` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `baudu_registras` VALUES (1,21,'Greičio viršijimas (+20 km/h)','2025-02-01',50.00,3,'07:09:37'),(2,22,'Neleistinas parkavimas','2025-02-05',30.00,5,'12:51:38'),(3,23,'Važiavimas be saugos diržo','2025-02-07',20.00,2,'18:49:21'),(4,24,'Raudono šviesoforo nepaisymas','2025-02-10',100.00,7,'14:31:55'),(5,25,'Netinkama eismo juosta','2025-02-12',25.00,1,'09:11:31'),(6,26,'Greičio viršijimas (+30 km/h)','2025-02-15',80.00,4,'12:21:51'),(7,27,'Automobilio palikimas ant žalios vejos','2025-02-18',40.00,8,'10:14:44'),(8,28,'Važiavimas be techninės apžiūros','2025-02-20',120.00,6,'07:08:07'),(9,29,'Neapmokėtas mokamas kelias','2025-02-22',15.00,9,'14:56:23'),(10,30,'Parkavimas neįgaliųjų vietoje','2025-02-25',150.00,10,'12:17:36'),(11,21,'Telefono naudojimas vairuojant','2025-02-26',35.00,3,'09:38:50'),(12,23,'Neįjungti žibintai dienos metu','2025-02-28',10.00,2,'21:21:24'),(13,25,'Važiavimas dviračių taku','2025-03-01',70.00,1,'19:50:34'),(14,27,'Netinkamas lenkimas','2025-03-03',90.00,8,'11:08:37'),(15,29,'Krovinio svorio viršijimas','2025-03-05',200.00,9,'23:11:24');
...
-- Dump completed on 2025-03-10  8:02:15
